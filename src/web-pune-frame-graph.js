...
// component.web-pune-frame-graph/DATA [22] 
export var DATA = [
  {
  "low":178.57,
  "high":180.99,
...
// component.web-pune-frame-graph/OPTIONS [84] 
export var OPTIONS = {
  "timeScale":{
    "timeVisible":true,
    "secondsVisible":true,
...
// component.web-pune-frame-graph/Demo002LightweightCharts [90] 
export function Demo002LightweightCharts(){
  ...
  return (
    <ReactNative.View ref={chartRef}/>);
}

// component.web-pune-frame-graph/MODULE [117] 
export var MODULE = {
  "DATA":DATA,
  "OPTIONS":OPTIONS,
