...
// js.react-native.ui-swiper/swiperTransform [15] 
export function swiperTransform({negEnabled,negFull,negThreshold,negThresholdInit,posEnabled,posFull,posThreshold,posThresholdInit}){
...
// js.react-native.ui-swiper/swiperTheme [40] 
export function swiperTheme({theme,themePipeline,...rprops}){
...
// js.react-native.ui-swiper/useSwiperPosition [57] 
export function useSwiperPosition({direction,fixedRef,negEnabled,negFull,negThreshold,negThresholdInit,onClosed,onOpened,opened,posEnabled,posFull,posThreshold,posThresholdInit,setDirection,setOpened}){
...
// js.react-native.ui-swiper/Swiper [110] 
export function Swiper({
  ...
  let [styleStatic,transformFn] = swiperTheme({
    ...
    themePipeline,
    "transformations":{
      "bg":React.useRef(swiperTransform(
  ...
  return (
    <ReactNative.View style={[...xtd.arrayify(styleContainer)]}>
      <physical_base.Box
        ...
        style={[styleStatic,...xtd.arrayify(style)]}
        addons={[
            {
