...
// js.react-native.animate-test/CreateTransitionDemo [77] 
export function CreateTransitionDemo(){
  let ind = React.useCallback(new ReactNative.Animated.Value(0),[]);
  let offFn = React.useRef(a.createTransition(ind,{
    "default":{
        "type":"timing",
        "duration":200,
        "easing":ReactNative.Easing.linear
      }
  },[30,0],k.identity)).current;
  let onFn = React.useRef(a.createTransition(ind,{
    "default":{
        "type":"timing",
        "duration":200,
        "easing":ReactNative.Easing.linear
      }
  },[0,30],k.identity)).current;
  let textRef = a.useListenSingle(ind,function (v){
    return {"text":str.to_fixed(v,3)};
  });
  return (
    <n.EnclosedCodeContainer
...
// js.react-native.animate-test/DeriveDemo [166] 
export function DeriveDemo(){
  ...
  let textRef = a.useListenArray([ind,ind2],function (v,v2){
    return {
      "text":(" ind: " + str.to_fixed(v,2)) + (", ind2: " + str.to_fixed(v2,2))
    };
  });
  return (
    <n.EnclosedCodeContainer
...
// js.react-native.animate-test/ListenSingleDemo [200] 
export function ListenSingleDemo(){
  ...
  React.useEffect(function (){
    a.listenSingle(textRef,ind,function (ind){
      return {"text":str.to_fixed(ind,2)};
    });
  },[]);
  return (
    <n.EnclosedCodeContainer
...
// js.react-native.animate-test/UseListenSingleDemo [233] 
export function UseListenSingleDemo(){
  let [active,setActive] = React.useState(1);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
...
// js.react-native.animate-test/ListenArrayDemo [263] 
export function ListenArrayDemo(){
  let [active,setActive] = React.useState(1);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
  ...
  React.useEffect(function (){
    a.listenArray(textRef,[ind,ind2],function (v,v2){
      return {
        "text":"[" + str.to_fixed(v,2) + ", " + str.to_fixed(v2,2) + "]"
      };
    });
  },[]);
  return (
...
// js.react-native.animate-test/UseListenArrayDemo [302] 
export function UseListenArrayDemo(){
  let [active,setActive] = React.useState(1);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
...
// js.react-native.animate-test/ListenMapDemo [356] 
export function ListenMapDemo(){
  let [active,setActive] = React.useState(1);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
  ...
  React.useEffect(function (){
    a.listenMap(textRef,{"ind":ind,"ind2":ind2},function ({ind,ind2}){
      return {
        "text":"[" + str.to_fixed(ind,2) + ", " + str.to_fixed(ind2,2) + "]"
      };
    });
  },[]);
  return (
...
// js.react-native.animate-test/ListenTransformationsDemo [414] 
export function ListenTransformationsDemo(){
  let [active,setActive] = React.useState(1);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
...
// js.react-native.animate-test/RunWithCancelDemo [473] 
export function RunWithCancelDemo(){
  let [active,setActive] = React.useState(true);
  let {check_fn,indicator,one_fn,zero_fn} = React.useRef(event_animate.make_binary_transitions(a.IMPL,active,{
    "default":{
        "type":"timing",
        "duration":1000,
        "easing":ReactNative.Easing.linear
...
// js.react-native.animate-test/RunWithOneDemo [524] 
export function RunWithOneDemo(){
  let [active,setActive] = React.useState(true);
  let progressing = React.useRef(event_animate.new_progressing()).current;
...
// js.react-native.animate-test/RunWithAllDemo [584] 
export function RunWithAllDemo(){
  let [active,setActive] = React.useState(true);
  let progressing = React.useRef(event_animate.new_progressing()).current;
  let [progressView,setProgressView] = React.useState(progressing);
  let {check_fn,indicator,one_fn,zero_fn} = React.useRef(event_animate.make_binary_transitions(a.IMPL,active,{
...
// js.react-native.animate-test/UseBinaryIndicatorDemo [647] 
export function UseBinaryIndicatorDemo(){
  let [active,setActive] = React.useState(true);
  let ind = a.useBinaryIndicator(active,{
    "default":{
        "type":"timing",
...
// js.react-native.animate-test/UsePressIndicatorDemo [695] 
export function UsePressIndicatorDemo(){
...
// js.react-native.animate-test/UseLinearIndicatorDemo [750] 
export function UseLinearIndicatorDemo(){
  let [index,setIndex] = React.useState(1);
  let [progress,setProgress] = React.useState();
...
// js.react-native.animate-test/UseIndexIndicatorDemo [814] 
export function UseIndexIndicatorDemo(){
  let [index,setIndex] = React.useState(1);
...
// js.react-native.animate-test/UseCircularIndicatorDemo [873] 
export function UseCircularIndicatorDemo(){
...
// js.react-native.animate-test/UsePositionDemo [959] 
...
// js.react-native.animate-test/UseRangeDemo [1014] 
export function UseRangeDemo(){
...
// js.react-native.animate-test/UseShowingDemo [1103] 
export function UseShowingDemo(){
