...
// js.react-native.ui-picker-basic/pickerTheme [17] 
...
// js.react-native.ui-picker-basic/usePickerPosition [34] 
...
// js.react-native.ui-picker-basic/PickerBasicIndexed [51] 
export function PickerBasicIndexed({
  theme,
  themePipeline,
  disabled,
  index,
    ...
    <physical_base.Box
      ...
      <physical_base.Text
        ...
        transformations={function ({offset,value}){
            return {"text":format(items[value],value)};
          }}/>
    </physical_base.Box>);
}