...
// js.react-native.ui-frame/translationOffset [11] 
export function translationOffset(location,visible,size){
  if(location == "left"){
...
// js.react-native.ui-frame/FramePane [27] 
export function FramePane({
  ...
  return (
    <physical_base.Box
      ...
      style={[{[aspect]:0},...xtd.arrayify(style)]}
      transformations={{
...
// js.react-native.ui-frame/Frame [67] 
