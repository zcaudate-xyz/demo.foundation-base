...
// js.react-native.ui-modal/ModalBackdrop [21] 
export function ModalBackdrop({children,chord,indicators,onClose,opacityBackdrop,permanent,styleBackdrop}){
  return (
      ...
      <ReactNative.TouchableWithoutFeedback
        ...
        <ReactNative.View style={{"flex":1}}>
          <physical_base.Box
            ...
            chord={chord}
            style={[{"flex":1},...xtd.arrayify(styleBackdrop)]}
            transformations={{
...
// js.react-native.ui-modal/useMeasureContent [53] 
export function useMeasureContent(children,visible,dimensions,setLayout){
...
// js.react-native.ui-modal/ModalElementAbsolute [76] 
export function ModalElementAbsolute({children,chord,dimensions,effect,indicators,margin,position,transition,visible}){
...
export function ModalElementHost({children,chord,dimensions,effect,hostRef,indicators,margin,position,transition,visible}){
  ...
  console.log(
    " js.react-native.ui-modal/ModalElementHost 145\n\n",
    layout,
    hostLayout
  );
  let layoutRef = r.useFollowRef(layout);
...
// js.react-native.ui-modal/Modal [185] 
