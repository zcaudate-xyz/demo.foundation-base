...
import * as ui_radio from './ui-radio.js'

import * as n from '../js/react-native.js'

// melbourne.ui-radio-test/RadioBoxDemo [28] 
...
// melbourne.ui-radio-test/RadioGroupIndexedDemo [74] 
export function RadioGroupIndexedDemo(){
  let [index,setIndex] = React.useState(1);
  return (
    <n.EnclosedCodeContainer
      label=" melbourne.ui-radio/RadioGroupIndexed"
      code={(function (){
          return "(\n  <n.Row>\n    <n.Row style={{\"backgroundColor\":\"#eee\",\"flex\":1,\"padding\":30}}>\n      <ui_radio.RadioGroupIndexed\n        design={{\"type\":\"light\"}}\n        items={[\" STATS \",\" XLM \",\" USD \"]}\n        index={index}\n        setIndex={setIndex}/>\n    </n.Row>\n    <n.Row style={{\"backgroundColor\":\"#333\",\"flex\":1,\"padding\":30}}>\n      <ui_radio.RadioGroupIndexed\n        design={{\"type\":\"dark\"}}\n        items={[\" STATS \",\" XLM \",\" USD \"]}\n        index={index}\n        setIndex={setIndex}/>\n    </n.Row>\n  </n.Row>);\n(\n  <n.TextDisplay content={JSON.stringify(index)}/>);";
        })()}>
      <n.Row>
        <n.Row style={{"backgroundColor":"#eee","flex":1,"padding":30}}>
          <ui_radio.RadioGroupIndexed
...
// melbourne.ui-radio-test/RadioGroupDemo [108] 
export function RadioGroupDemo(){
  ...
  return (
    <n.EnclosedCodeContainer
      ...
      code={(function (){
          return "(\n  <n.Row>\n    <n.Row style={{\"backgroundColor\":\"#eee\",\"flex\":1,\"padding\":30}}>\n      <ui_radio.RadioGroup\n        design={{\"type\":\"light\"}}\n        data={[\"STATS\",\"XLM\",\"USD\"]}\n        value={value}\n        setValue={setValue}\n        format={function (s){\n            return \"  \" + s;\n          }}/>\n    </n.Row>\n    <n.Row style={{\"backgroundColor\":\"#333\",\"flex\":1,\"padding\":30}}>\n      <ui_radio.RadioGroup\n        design={{\"type\":\"dark\"}}\n        data={[\"STATS\",\"XLM\",\"USD\"]}\n        value={value}\n        setValue={setValue}\n        format={function (s){\n            return \"  \" + s;\n          }}/>\n    </n.Row>\n  </n.Row>);\n(\n  <n.TextDisplay content={JSON.stringify(value)}/>);";
        })()}>
      <n.Row>
        <n.Row style={{"backgroundColor":"#eee","flex":1,"padding":30}}>
          <ui_radio.RadioGroup
...
// melbourne.ui-radio-test/MODULE [142] 
export var MODULE = {
