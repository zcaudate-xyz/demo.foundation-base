...
// melbourne.ui-text-test/EnumMinorDemo [28] 
export function EnumMinorDemo(){
...
// melbourne.ui-text-test/TabsMinorDemo [54] 
export function TabsMinorDemo(){
...
// melbourne.ui-text-test/EnumAccentDemo [80] 
export function EnumAccentDemo(){
  let [values,setValues] = React.useState(["USD"]);
  return (
    <n.EnclosedCodeContainer
...
// melbourne.ui-text-test/TabsAccentDemo [106] 
export function TabsAccentDemo(){
  let [value,setValue] = React.useState("USD");
  return (
    <n.EnclosedCodeContainer
...
// melbourne.ui-text-test/HeaderBaseDemo [135] 
export function HeaderBaseDemo(){
...
// melbourne.ui-text-test/TextBaseDemo [244] 
...
// melbourne.ui-text-test/ActivityIndicatorDemo [303] 
export function ActivityIndicatorDemo(){
  return (
    <n.EnclosedCodeContainer
      label="melbourne.ui-text/ActivityIndicator"
      code={(function (){
          return "(\n  <n.Row>\n    <ui_section.SectionBase design={{\"type\":\"light\"}}>\n      <ui_text.ActivityIndicator design={{\"type\":\"light\"}}/>\n      <ui_text.ActivityIndicator design={{\"type\":\"light\"}} size={100}/>\n    </ui_section.SectionBase>\n    <ui_section.SectionBase design={{\"type\":\"dark\"}}>\n      <ui_text.ActivityIndicator design={{\"type\":\"dark\"}}/>\n      <ui_text.ActivityIndicator design={{\"type\":\"light\"}} size={100}/>\n    </ui_section.SectionBase>\n  </n.Row>);";
        })()}>
      <n.Row>
        <ui_section.SectionBase design={{"type":"light"}}>
          <ui_text.ActivityIndicator design={{"type":"light"}}/>
...
// melbourne.ui-text-test/IconDemo [328] 
export function IconDemo(){
  return (
    <n.EnclosedCodeContainer
      label="melbourne.ui-text/Icon"
      code={(function (){
          return "(\n  <n.Row>\n    <ui_section.SectionBase design={{\"type\":\"light\"}}>\n      <ui_text.Icon design={{\"type\":\"light\"}} name=\"close\"/>\n      <ui_text.Icon design={{\"type\":\"light\"}} name=\"close\" size={100}/>\n    </ui_section.SectionBase>\n    <ui_section.SectionBase design={{\"type\":\"dark\"}}>\n      <ui_text.Icon design={{\"type\":\"dark\"}} name=\"close\"/>\n      <ui_text.Icon design={{\"type\":\"light\"}} name=\"close\" size={100}/>\n    </ui_section.SectionBase>\n  </n.Row>);";
        })()}>
      <n.Row>
        <ui_section.SectionBase design={{"type":"light"}}>
          <ui_text.Icon design={{"type":"light"}} name="close"/>
...
// melbourne.ui-text-test/AvatarDemo [357] 
export function AvatarDemo(){
  return (
    <n.EnclosedCodeContainer
      label="melbourne.ui-text/Avatar"
      code={(function (){
          return "(\n  <n.Row>\n    <ui_section.SectionBase design={{\"type\":\"light\"}}>\n      <ui_text.Avatar design={{\"type\":\"light\"}} text=\"H\"/>\n      <ui_text.Avatar design={{\"type\":\"light\"}} text=\"H\" size={100}/>\n    </ui_section.SectionBase>\n    <ui_section.SectionBase design={{\"type\":\"dark\"}}>\n      <ui_text.Avatar design={{\"type\":\"dark\"}} text=\"H\"/>\n      <ui_text.Avatar design={{\"type\":\"light\"}} text=\"H\" size={100}/>\n    </ui_section.SectionBase>\n  </n.Row>);";
        })()}>
      <n.Row>
        <ui_section.SectionBase design={{"type":"light"}}>
          <ui_text.Avatar design={{"type":"light"}} text="H"/>
...
// melbourne.ui-text-test/MinorBaseDemo [395] 
export function MinorBaseDemo(){
  let [color,setColor] = React.useState("purple");
  let [type,setType] = React.useState("dark");
  let [foil,setFoil] = React.useState("background");
...
// melbourne.ui-text-test/AccentBaseDemo [477] 
export function AccentBaseDemo(){
  let [color,setColor] = React.useState("purple");
  let [type,setType] = React.useState("dark");
  let [foil,setFoil] = React.useState("background");
  let [selected,setSelected] = React.useState();
...
// melbourne.ui-text-test/ButtonTooltipDemo [556] 
export function ButtonTooltipDemo(){
  let mainComponent = React.useRef(function (){
    return (
...
// melbourne.ui-text-test/ConfirmTooltipDemo [604] 
export function ConfirmTooltipDemo(){
  return (
    <n.Isolation>
      <n.EnclosedCodeContainer
...
// melbourne.ui-text-test/TextAltDemo [643] 
export function TextAltDemo(){
  return (
    <n.EnclosedCodeContainer
      label="melbourne.ui-text/TextAlt"
      code={(function (){
          return "(\n  <n.Row>\n    <ui_section.SectionBase design={{\"type\":\"light\"}}>\n      <n.Row>\n        <ui_text.TextAlt design={{\"type\":\"light\"}} value={{\"a\":1,\"b\":2}}/>\n      </n.Row>\n    </ui_section.SectionBase>\n    <ui_section.SectionBase design={{\"type\":\"dark\"}}>\n      <n.Row>\n        <ui_text.TextAlt design={{\"type\":\"dark\"}} value={{\"a\":1,\"b\":2}}/>\n      </n.Row>\n    </ui_section.SectionBase>\n  </n.Row>);";
        })()}>
      <n.Row>
        <ui_section.SectionBase design={{"type":"light"}}>
          <n.Row>
...
// melbourne.ui-text-test/MODULE [664] 
export var MODULE = {
