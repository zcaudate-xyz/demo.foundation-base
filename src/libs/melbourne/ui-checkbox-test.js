...
// melbourne.ui-checkbox-test/CheckBoxDemo [31] 
...
// melbourne.ui-checkbox-test/CheckGroupIndexedDemo [96] 
export function CheckGroupIndexedDemo(){
  let [indices,setIndices] = React.useState([false,true,false]);
  return (
    <n.EnclosedCodeContainer
      label=" melbourne.ui-checkbox/CheckGroupIndexed"
      code={(function (){
          return "(\n  <n.Row>\n    <n.Row style={{\"backgroundColor\":\"#eee\",\"flex\":1,\"padding\":30}}>\n      <ui_checkbox.CheckGroupIndexed\n        design={{\"type\":\"light\"}}\n        items={[\" STATS \",\" XLM \",\" USD \"]}\n        indices={indices}\n        setIndices={setIndices}/>\n    </n.Row>\n    <n.Row style={{\"backgroundColor\":\"#333\",\"flex\":1,\"padding\":30}}>\n      <ui_checkbox.CheckGroupIndexed\n        design={{\"type\":\"dark\"}}\n        items={[\" STATS \",\" XLM \",\" USD \"]}\n        indices={indices}\n        setIndices={setIndices}/>\n    </n.Row>\n  </n.Row>);\n(\n  <n.TextDisplay content={JSON.stringify(indices)}/>);";
        })()}>
      <n.Row>
        <n.Row style={{"backgroundColor":"#eee","flex":1,"padding":30}}>
          <ui_checkbox.CheckGroupIndexed
...
// melbourne.ui-checkbox-test/CheckGroupDemo [130] 
export function CheckGroupDemo(){
  let [values,setValues] = React.useState(["USD"]);
  return (
    <n.EnclosedCodeContainer
      label=" melbourne.ui-checkbox/CheckGroup"
      code={(function (){
          return "(\n  <n.Row>\n    <n.Row style={{\"backgroundColor\":\"#eee\",\"flex\":1,\"padding\":30}}>\n      <ui_checkbox.CheckGroup\n        design={{\"type\":\"light\"}}\n        data={[\"STATS\",\"XLM\",\"USD\"]}\n        values={values}\n        setValues={setValues}\n        format={function (s){\n            return \"  \" + s;\n          }}/>\n    </n.Row>\n    <n.Row style={{\"backgroundColor\":\"#333\",\"flex\":1,\"padding\":30}}>\n      <ui_checkbox.CheckGroup\n        design={{\"type\":\"dark\"}}\n        data={[\"STATS\",\"XLM\",\"USD\"]}\n        values={values}\n        setValues={setValues}\n        format={function (s){\n            return \"  \" + s;\n          }}/>\n    </n.Row>\n  </n.Row>);\n(\n  <n.TextDisplay content={JSON.stringify(values)}/>);";
        })()}>
      <n.Row>
        <n.Row style={{"backgroundColor":"#eee","flex":1,"padding":30}}>
          <ui_checkbox.CheckGroup
...
// melbourne.ui-checkbox-test/MODULE [164] 
export var MODULE = {
