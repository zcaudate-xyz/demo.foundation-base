...
// melbourne.slim-common-test/FormReadOnlyDemo [62] 
export function FormReadOnlyDemo(){
  let entry = {"name":"abc"};
  return (
    <n.EnclosedCodeContainer
...
// melbourne.slim-common-test/FormInputDemo [94] 
...
// melbourne.slim-common-test/FormInputXLDemo [139] 
export function FormInputXLDemo(){
  let form = ext_form.makeForm(function (){
    return {"name":"abc"};
  },{"name":[validators.is_not_empty()]});
  React.useEffect(function (){
...
// melbourne.slim-common-test/FormTextAreaDemo [176] 
...
// melbourne.slim-common-test/FormCheckBoxDemo [212] 
...
// melbourne.slim-common-test/FormToggleButtonDemo [246] 
export function FormToggleButtonDemo(){
  let form = ext_form.makeForm(function (){
    return {"agree":false};
  },{"agree":[]});
  return (
...
// melbourne.slim-common-test/FormToggleSwitchDemo [280] 
export function FormToggleSwitchDemo(){
  let form = ext_form.makeForm(function (){
    return {"agree":false};
  },{"agree":[]});
  return (
...
// melbourne.slim-common-test/FormEnumSingleDemo [312] 
export function FormEnumSingleDemo(){
  let form = ext_form.makeForm(function (){
    return {"currency":"XLM"};
  },{"currency":[]});
  return (
...
// melbourne.slim-common-test/FormEnumMultiDemo [346] 
export function FormEnumMultiDemo(){
  let form = ext_form.makeForm(function (){
...
// melbourne.slim-common-test/FormColorInputDemo [380] 
export function FormColorInputDemo(){
  let form = ext_form.makeForm(function (){
    return {"color":"#456789"};
  },{"color":[]});
  return (
...
// melbourne.slim-common-test/FormChipInputDemo [412] 
export function FormChipInputDemo(){
  let form = ext_form.makeForm(function (){
  ...
  return (
    <n.EnclosedCodeContainer
      ...
      code={(function (){
          return "(\n  <n.Row>\n    <ReactNative.View style={{\"backgroundColor\":\"#eee\",\"flex\":1,\"padding\":10}}>\n      <slim_common.FormChipInput\n        design={{\"type\":\"light\"}}\n        label=\"Tags\"\n        form={form}\n        field=\"tags\"/>\n    </ReactNative.View>\n    <ReactNative.View style={{\"backgroundColor\":\"#333\",\"flex\":1,\"padding\":10}}>\n      <slim_common.FormChipInput design={{\"type\":\"dark\"}} label=\"Tags\" form={form} field=\"tags\"/>\n    </ReactNative.View>\n  </n.Row>);";
        })()}>
      <n.Row>
        <ReactNative.View style={{"backgroundColor":"#eee","flex":1,"padding":10}}>
          <slim_common.FormChipInput
...
// melbourne.slim-common-test/FormLayoutDemo [444] 
...
// melbourne.slim-common-test/MODULE [504] 
export var MODULE = {
