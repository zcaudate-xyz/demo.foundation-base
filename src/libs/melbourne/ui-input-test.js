...
// melbourne.ui-input-test/RegistraionValidators [37] 
export var RegistraionValidators = {
  "first_name":[
    [
    "is-not-empty",
    {
...
// melbourne.ui-input-test/inputAsterix [49] 
export function inputAsterix(design){
...
// melbourne.ui-input-test/styleInputLabel [66] 
export function styleInputLabel({mainNeutral},m){
...
// melbourne.ui-input-test/InputLightExamples [81] 
export function InputLightExamples(){
...
// melbourne.ui-input-test/InputDarkExamples [159] 
export function InputDarkExamples(){
  let form = ext_form.makeForm(function (){
    return {"first_name":"","last_name":""};
  },RegistraionValidators);
  let {data,result} = ext_form.listenForm(form);
...
// melbourne.ui-input-test/MODULE [235] 
export var MODULE = {
