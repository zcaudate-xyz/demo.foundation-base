...
// xt.event.util-validate/validate-step [35] 
export function validate_step(form,field,guards,index,result,hook_fn,complete_fn){
...
// xt.event.util-validate/validate-field [91] 
export function validate_field(form,field,validators,result,hook_fn,complete_fn){
...
// xt.event.util-validate/validate-fields-loop [104] 
export function validate_fields_loop(form,validators,result,fields,index,hook_fn,complete_fn){
...
// xt.event.util-validate/validate-all [130] 
export function validate_all(form,validators,result,hook_fn,complete_fn){
  let fields = Object.keys(validators);
  return validate_fields_loop(form,validators,result,fields,0,hook_fn,complete_fn);
}

// xt.event.util-validate/create-result [137] 
export function create_result(validators){
  let result = {
    "::":"validation.result",
    "status":"pending",
